...
#pragma region ThietLapAP
  ...
  if (this->DaBatAP == false) {
    ...
    // Chuyển sang mode phát Access Point 
    WiFi.mode(WIFI_AP);
...
#pragma region ServerON
  ...
  server.on("/LuuMACSlaveVaoEEPROM", WIFI::LuuMACSlaveVaoEEPROM);  // Gọi hàm khi user bấm nút LuuMACSlaveVaoEEPROM
  server.begin();                                                  // Khởi động server
#pragma endregion ServerON
}

//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
void WIFI::LuuMACSlaveVaoEEPROM(void) {
#pragma region LuuMACSlaveVaoEEPROM
  //===============================================================================
  String MACSlave = server.arg("MACSlave");
  ...
  for (int i = 0; i < MACSlave.length(); ++i) {
    EEPROM.write(i, MACSlave[i]);
  }

#ifdef debug
  Serial.println("Đã Lưu MACs vào EEPROM...");
#endif
  ...
  String str;
  str = "Lưu thành công MACs: MACSlave:";
  str += MACSlave;
  server.send(200, "text/html", str);
  //===============================================================================
#pragma endregion LuuMACSlaveVaoEEPROM
}
//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
